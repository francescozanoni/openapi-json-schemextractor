...
const fixJsonSchema = require("./json-schema-fixer");
...
const urlExist = require("url-exist");
     ...
     */
    async function from(inputSchema, keysToRemove) {
...
const Converter = {
    ...
    fromObject: async function (schemaObject, keysToRemove) {
        ...
        return await from(schemaObject, keysToRemove);
    ...
    fromFile: async function (schemaFilePath, keysToRemove) {
        ...
        return await from(schemaFilePath, keysToRemove);
